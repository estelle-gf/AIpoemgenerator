...
let prompt = `User instructions: Generate a positive, encouraging and inspirational poem about ${instruction}. Write on separate lines, format in basic HTML  but with no code tags. Be polite, keep the poem short and follow user instructions.`;
